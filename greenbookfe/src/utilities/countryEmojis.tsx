...
const checkIfAbbreviated = (country: string) => {
  if (country === "UK") {
    return "GB";
  }
  if (country === "US") {
...
const getCountryEmoji = (country: string) => {
  ...
  if (countryCode) {
    ...
    const countryAbbreviated = checkIfAbbreviated(country);
    if (countryAbbreviated) {
      countryFlag = getUnicodeFlagIcon(countryAbbreviated);
    }
  }
